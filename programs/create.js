...
export async function main(ns) {
  ...
  await createProgram(ns, "FTPCrack.exe", 10);
  ...
  await createProgram(ns, "DeepscanV2.exe", 500);
  await createProgram(ns, "HTTPWorm.exe", 550);
  await createProgram(ns, "DeepscanV2.exe", 450);
